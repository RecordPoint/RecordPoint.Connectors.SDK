...
namespace RecordPoint.Connectors.SDK.Extensions
{
    ...
    public class CustomFallbackPolicy : Policy, IFallbackPolicy
    {
        ...
        public CustomFallbackPolicy(Action<Action<Context, CancellationToken>, Context, CancellationToken> exceptionPolicy, IEnumerable<ExceptionPredicate> exceptionPredicates)
        ...
        /// <param name="exceptionPredicates"></param>
        public CustomFallbackPolicy(Func<Func<Context, CancellationToken, Task>, Context, CancellationToken, bool, Task> asyncExceptionPolicy, IEnumerable<ExceptionPredicate> exceptionPredicates) : base(asyncExceptionPolicy, exceptionPredicates)
        {
        }
        ...
        /// <summary>
        /// Making sure the Exception of Policy.On<Exception> is handled
        /// </summary>
